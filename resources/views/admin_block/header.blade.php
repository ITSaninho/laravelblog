    ...
    <div class="navbar navbar-default navbar-static-top container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li class="dropdown">
                    <a class="dropdown-toggle" href="{{url('/')}}">Головна<i class="fa fa-angle-down"></i>
                    </a>
                </li>

                <li class="dropdown">
                    <a class="dropdown-toggle" href="{{ route('portfolio')}}">Портфоліо<i class="fa fa-angle-down"></i></a>
                </li>
